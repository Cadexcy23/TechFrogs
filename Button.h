...
public:
	...
	static button makeButton(std::vector<SDL_Texture*> texSet, int x, int y, int frameTime, void(*activateFunc)(), int w = 0, int h = 0);

	static void updateButtonVector(std::vector<button> buttonList);
};